          ...
          return (
            ...
            >
              <div className="flex items-start justify-between w-full">
                ...
                <button onClick={() => handleAddToCart(item)} className="bg-[#2e4a40] text-[#02ca3a] p-1 rounded-md"><FaShoppingCart size={10} /></button>
              </div>
              <div className="flex items-center justify-between w-full">
                <p className="text-[#f5f5f5] text-base font-bold">
                  ৳{item.price}
                </p>
                <div className="flex items-center justify-between bg-[#1f1f1f] px-1 py-2 rounded-lg gap-6 w-[50%]">
                  <button
