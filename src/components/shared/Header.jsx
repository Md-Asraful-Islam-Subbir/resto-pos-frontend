...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center py-1 px-2 bg-[#062117] ">
      {/* LOGO */}
      ...
      {/* SEARCH */}
      <div className="flex items-center gap-4 bg-[#1f1f1f] rounded-[15px] px-2.5 py-1 w-[500px]">
      ...
      <div className="flex items-center gap-2">
        {userData.role === "Admin" && (
          <div onClick={() => navigate("/dashboard")} className="bg-[#1f1f1f] rounded-[7px] p-3 cursor-pointer">
            <MdDashboard className="text-[#f5f5f5] text-lg" />
          </div>
        )}
        <div className="bg-[#1f1f1f] rounded-[7px] p-3 cursor-pointer">
