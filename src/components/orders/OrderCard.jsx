...
const OrderCard = ({ key, order }) => {
  ...
  return (
    <div key={key} className="w-[400px] bg-gray-700 p-4 rounded-lg mb-4">
      <div className="flex items-center gap-5">
        <button className="bg-[#f6b100] p-3 text-basw font-bold rounded-lg">
      ...
      <div className="flex items-center justify-between mt-1">
        <h1 className="text-[#f5f5f5] text-base font-normal">Total</h1>
